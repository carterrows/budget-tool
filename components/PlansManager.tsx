...
export default function PlansManager({ username }: PlansManagerProps) {
  ...
  if (loading) {
    return (
      <section className="card mx-auto w-full max-w-5xl p-8">
  ...
  if (error && plans.length === 0) {
    return (
      <section className="mx-auto w-full max-w-5xl rounded-2xl border border-rose-200 bg-white p-8 shadow-card">
